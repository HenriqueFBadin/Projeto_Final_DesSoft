...
sr_dio_img=pygame.image.load('Imagem/DIO_Socando_Direita.png')
sl_dio_img=pygame.image.load('Imagem/DIO_Socando_Esquerda.png')
ar_dio_img=pygame.image.load('Imagem/DIO_Atirando_Direita.png')
al_dio_img=pygame.image.load('Imagem/DIO_Atirando_Esquerda.png')
